...
{/* The most common solution to deal with Theresis phase 2 in this scenario is with Amiya+May. Amiya deals true damage with her S3 and can be placed early to start charging her skill.

<div style={{ display: "flex", justifyContent: "center", alignItems: "center"  }}>
  ![Amiya placement 1](/guides/is5-sarkaz/stage-guides/court-visit/ed2-amiya-1.png)
</div>

When boats start spawning, as mentioned earlier, she will be on a timer to charge her skill and deal damage, for this we deploy May to slow down the boats and buy more time for Amiya. Their placements go as follows:

<div style={{ display: "flex", justifyContent: "center", alignItems: "center"  }}>
  ![Amiya placement 2](/guides/is5-sarkaz/stage-guides/court-visit/ed2-amiya-2.png)
</div>
...
This stage opening is relatively slow compared to other stages, this gives enough time to set up your operators and heal any that would require so. For the second phase however, depending on the strategy chosen, if operators must be constantly deployed as Theresa is constantly charging her skill at +5 SP/s, this will not allow your operators to survive and do their job if they aren't healed in time.
...
In most cases Amiya skill will give her enough HP to survive Theresa's explosions, on the other hand, May will usually instantly die after a few cycles if she does not have a decent amount of HP, as these explosions can reach 5,000 Arts damage as the phase progresses, starting from 500 and increasing by 200 every explosion. Because of this, the placement should be carefully thought of in consideration of the boats position in the cycle and Theresa's SP bar. Sarkaz Withers can be defeated to manipulate Theresa's SP bar, by killing devouers to force an early explosion, or avoid killing them for a late explosion, as killing a sarkaz enemy restores 3 SP.
...
May is then deployed on D10 after the first boat is out of range (D8), while the second boat would be exiting D11 and the 3rd boat would be on B5-B6.
...
Simulating this we can consider the following scenarios to compare the impact if ASPD relics vs damage relics.

At this point of the run it is fair to assume that we have triple King's relics, that is King's Crown providing 150% internal damage. We also have 30% external attack from the tree and likely a few more external attack buffs, given how common they are in comparison to other internal buffs. Here we can consider the following additional ASPD breakpoints:
* King's Lance = 50 ASPD
* King's Lance + 80 ingots Toy = ~100 ASPD
* King's Lance + 150 ingots Toy and Chalice = 350 ASPD
* Max ASPD = 500 ASPD

Something reasonable to consider into this analysis is the effect of the relic Civilight Eterna, which increases True damage taken by enemies by 250%, resulting in a x3.5 final damage output multiplier. This simply ends up being a x3.5 multiplier to her final DPS output, which will depend on her base damage and ASPD, meaning that at low ASPD scenarios it won't perform as well as one might expect.

Next we compare the total DPS per cycle, a cycle being, given a certain ASPD on May to slow down the boat, the time Amiya gets to deal damage, either by charging her skill and being forcefully retreated by it or manually retreating her before a boat kidnaps her, in addition to her redeployment time.
...
At the bottom we have 50 ASPD, the scenario without Toy or Chalice. Just obtaining Toy with 80 ingots is enough to quadruple her damage and in most scenarios we would have more than just 80 ingots, however, if we look at the damage with an additional 200% external damage this a x2.5 increase.
With Chalice we can see an even bigger increase of damage that no realistic run would get enough damage to match it.
...
<div style={{ display: "flex", justifyContent: "center", alignItems: "center"  }}>
  ![Amiya DPS cycle with E1 May](/guides/is5-sarkaz/stage-guides/court-visit/strategy-amiya-may/amiya-may-dps-cycle-e1-may.png)
</div>


It is important to note that this analysis is done considering E1 May. E2 May will have an easier time slowing down the boats and providing Amiya more time to charge her skill which is the biggest problem on low ASPD scenarios. Even in this case the ASPD impact is still very noticeable.

<div style={{ display: "flex", justifyContent: "center", alignItems: "center"  }}>
  ![Amiya DPS cycle with E2 May](/guides/is5-sarkaz/stage-guides/court-visit/strategy-amiya-may/amiya-may-dps-cycle-e2-may.png)
</div>
...
While it is optimistic to manage to get a full skill duration before a boat reaches Amiya on a low ASPD scenario, we can still achieve a close estimate if we have additional operators to load into the boats to buy more time for her.

Amiya has 762 base ATK, with the +30% external ATK from the tree, King's Crown +150% internal ATK, Rise and Fall +30% external ATK, and her skill +230% internal ATK, this would be 5,852 ATK.
Amiya has an ATK Interval of 1.6s, with 50 ASPD from King's Lance this would be 1.0667s.
For a 30s skill, this would be 164,592 total damage, over 4 cycles this would be 60% of Theresis HP.
A combination of ASPD or external ATK buffs would be ideal to allow Amiya to deal with the entire stage when no ASPD was able to be obtained and no other operators were drafted to help with the damage, although it is important to consider that the stage will grow harder the longer Theresis remains alive and this still requires Amiya to be able to use her skill for its full duration.
