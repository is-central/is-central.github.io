...
This difference appears mainly because she only gets around 5s of skill uptime before she has to be retreated, compared to 17.5s at 100 ASPD, in which case it would be significantly better to load an operator into the boat instead of relying on May to slow down the boat.
