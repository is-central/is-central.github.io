...
Something reasonable to consider into this analysis is the effect of the relic Civilight Eterna, which increases True damage taken by enemies by 250%, resulting in a x3.5 final damage output multiplier.
This simply ends up being a x3.5 multiplier to her final DPS output, which will depend on her base damage and ASPD, meaning that at low ASPD scenarios it won't perform as well as one might expect.
...
It is important to note that this analysis is done considering E1 May.
...
* +150% internal ATK from King's Crown +150%
* +230% internal ATK from her skill +230%
...
A combination of ASPD or external ATK buffs would be ideal to allow Amiya to deal with the entire stage when no additional ASPD was obtained and no other operators were drafted to help with the damage.
