...
## Recommendations
With the correct timing, it is possible to block-shift the enemy upwards so they fall into the hole, removing a large threat of the stage. 
...
Example video link:
* <a href="https://b23.tv/Hzz7HIl" target="_blank" rel="noopener noreferrer">Push into hole example</a>
