...
Our [Getting Started](/general-knowledge/getting-started/) guide explains all the fundamentals of IS a new player should familiarize themselves with, and gives some insight into what top IS gameplay is like.
