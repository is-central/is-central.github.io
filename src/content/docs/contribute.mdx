...
Register a Github account if you don't have one. We still require the Github account for tracking who is responsible for what edits.

Visit [https://is-central.netlify.app/admin/index.html#/](https://is-central.netlify.app/admin/index.html#/) and login with Github.
...
You can toggle between Rich text (like a Google Doc) and Markdown (like Discord). Markdown is generally preferred.
