...
Check the templates page for templates to use when writing guides.

<div class="template-overview-button">
  <a href="/templates/overview" class="guide-button">
    <div class="button-image">
      <div class="reference-icon">📋</div>
    </div>
    <div class="button-content">
      <span class="button-title">Templates Overview</span>
      <span class="button-subtitle">Overview page for templates</span>
    </div>
...
Visit the <a href="https://is-central.netlify.app/admin/index.html#/" target="_blank" rel="noopener noreferrer">IS Central Netlify Admin page</a> and login with Github.
...
First, go to the <a href="https://github.com/is-central/is-central.github.io" target="_blank" rel="noopener noreferrer">IS Central GitHub repository</a> and **fork** the repository.
...
You can learn more about markdown <a href="https://www.markdownguide.org/getting-started/" target="_blank" rel="noopener noreferrer">here</a>.
